		...
		btnAceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (nombre.isEmpty() || apellido.isEmpty() || dni.isEmpty() || correo.isEmpty() || contrasenia.isEmpty()
						|| direccion.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Por favor, complete todos los campos.", "Error de Registro",
							JOptionPane.ERROR_MESSAGE);
					LOGGER.log(Level.SEVERE,
							"Se ha intentado registrar un usuario sin tener todos los campos de datos completados.");
				} else {
					...
					if (dniCorrecto(dni) == true) {
						...
						VentanaPrincipal vent = new VentanaPrincipal(g, gbd);
						vent.mostrarVentana();
					} else {
						JOptionPane.showMessageDialog(null, "El DNI no tiene el formato correcto", "Error de Registro",
								JOptionPane.ERROR_MESSAGE);
						LOGGER.log(Level.SEVERE,
								"Se ha intentado registrar un usuario con un DNI con formato incorrecto.");
					}
